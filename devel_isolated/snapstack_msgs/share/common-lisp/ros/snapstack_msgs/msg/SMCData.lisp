...
(cl:defmethod cl:initialize-instance :after ((m <SMCData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SMCData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name snapstack_msgs-msg:<SMCData> is deprecated: use snapstack_msgs-msg:SMCData instead.")))
...
(cl:defmethod q_des-val ((m <SMCData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader snapstack_msgs-msg:q_des-val is deprecated.  Use snapstack_msgs-msg:q_des instead.")
  (q_des m))

(cl:ensure-generic-function 'q_act-val :lambda-list '(m))
(cl:defmethod q_act-val ((m <SMCData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader snapstack_msgs-msg:q_act-val is deprecated.  Use snapstack_msgs-msg:q_act instead.")
  (q_act m))

(cl:ensure-generic-function 'q_err-val :lambda-list '(m))
(cl:defmethod q_err-val ((m <SMCData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader snapstack_msgs-msg:q_err-val is deprecated.  Use snapstack_msgs-msg:q_err instead.")
  (q_err m))

(cl:ensure-generic-function 'w_des-val :lambda-list '(m))
(cl:defmethod w_des-val ((m <SMCData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader snapstack_msgs-msg:w_des-val is deprecated.  Use snapstack_msgs-msg:w_des instead.")
  (w_des m))

(cl:ensure-generic-function 'w_act-val :lambda-list '(m))
(cl:defmethod w_act-val ((m <SMCData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader snapstack_msgs-msg:w_act-val is deprecated.  Use snapstack_msgs-msg:w_act instead.")
  (w_act m))

(cl:ensure-generic-function 'w_err-val :lambda-list '(m))
(cl:defmethod w_err-val ((m <SMCData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader snapstack_msgs-msg:w_err-val is deprecated.  Use snapstack_msgs-msg:w_err instead.")
  (w_err m))

(cl:ensure-generic-function 's-val :lambda-list '(m))
(cl:defmethod s-val ((m <SMCData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader snapstack_msgs-msg:s-val is deprecated.  Use snapstack_msgs-msg:s instead.")
  (s m))

(cl:ensure-generic-function 'integrator-val :lambda-list '(m))
(cl:defmethod integrator-val ((m <SMCData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader snapstack_msgs-msg:integrator-val is deprecated.  Use snapstack_msgs-msg:integrator instead.")
  (integrator m))
