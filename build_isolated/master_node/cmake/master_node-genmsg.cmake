...
message(STATUS "master_node: 1 messages, 0 services")

set(MSG_I_FLAGS "-Imaster_node:/home/sangita/project_ws/AER1516/src/master_node/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/sangita/project_ws/AER1516/src/master_node/msg/MasterNodeState.msg" NAME_WE)
add_custom_target(_master_node_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "master_node" "/home/sangita/project_ws/AER1516/src/master_node/msg/MasterNodeState.msg" "std_msgs/Header"
)
...
### Generating Messages
_generate_msg_cpp(master_node
  "/home/sangita/project_ws/AER1516/src/master_node/msg/MasterNodeState.msg"
  "${MSG_I_FLAGS}"
...
### Generating Messages
_generate_msg_lisp(master_node
  "/home/sangita/project_ws/AER1516/src/master_node/msg/MasterNodeState.msg"
  "${MSG_I_FLAGS}"
  "/opt/ros/melodic/share/std_msgs/cmake/../msg/Header.msg"
...
### Generating Messages
_generate_msg_nodejs(master_node
  "/home/sangita/project_ws/AER1516/src/master_node/msg/MasterNodeState.msg"
  "${MSG_I_FLAGS}"
  "/opt/ros/melodic/share/std_msgs/cmake/../msg/Header.msg"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/master_node)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/master_node\")")
  # install generated code
  install(
